...
def SendEmail(receiver_email):
    ...
    Check at http://www.chem.utoronto.ca/cgi-bin/Calcium40_cni.pl?Op=ShowIt&CalendarName=ESEM__STEM."""
    server.starttls()
...
for i in range(len(day_track)):
    ...
    # print (day,starttime,stoptime)
    # print (new_timetable[starttime:stoptime,day])
    # print (old_timetable[starttime:stoptime,day])
    if (new_timetable[starttime:stoptime,day] == old_timetable[starttime:stoptime,day]).all() != True:
